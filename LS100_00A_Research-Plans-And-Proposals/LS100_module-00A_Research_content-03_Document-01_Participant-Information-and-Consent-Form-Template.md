...
title: 'Participant Information and Consent Form — Template'
short_title: 'Document 01: Consent Form'
exports:
  - format: pdf
    template: lapreprint-typst
    output: exports/LS100_module-00A_Research_content-03_Document-01_Participant-Information-and-Consent-Form-Template_LastUpdated-20260920.pdf
    id: consent-pdf
downloads:
  - id: consent-pdf
    title: Download the form (PDF)
---
...
:::{danger} This is a teaching template, not an approved consent form
This document exists so you have somewhere to start, and so you can see what informed consent actually has to cover. **It has not been reviewed or approved by any ethics committee, and it does not by itself make your study permissible.**

Every `[BRACKETED ITEM]` is a placeholder you must replace with your own study's details. Do not hand this to anyone with brackets still in it.

Before you record any person, follow the pathway in **"Before you use this template"** below. Harvard publishes its own authoritative consent templates — **HRP-502 (Adult Consent)** and **HRP-502-c (Exempt Research Consent Script)** — in the ESTR Library under *Templates and Forms*; use the **HUA**-labelled versions. If anything here conflicts with what the Committee on the Use of Human Subjects (CUHS) tells you, **CUHS is right and this document is wrong**.
:::
...
1. **Start at the [URTP Portal](https://cuhs.harvard.edu/urtp-portal).** Identify a Research Supervisor and complete the required ethics training (IRB-led or CITI).
2. **Complete the URTP Decision Form.** It is reviewed by an IRB regulatory expert — this is how it gets decided whether your specific project needs IRB review, and it is not a formality you self-assess.
3. **Do not self-certify as "exempt."** CUHS is unambiguous in its [FAQs](https://cuhs.harvard.edu/faqs): *"The regulatory category of 'exempt' research must be reviewed by CUHS prior to being carried out. Whether your study is exempt is a determination made by the designated CUHS staff person who reviews your application."*
4. **If review is needed**, submissions go through **ESTR** at [irb.harvard.edu](https://irb.harvard.edu) and require an HUID. An undergraduate may be listed as PI, but [only with a PI-eligible faculty sponsor also listed](https://cuhs.harvard.edu/am-I-PI-eligible).
5. **Only then start recording.** If the initial intent is for the data to be used beyond the classroom, Harvard puts the responsibility on the faculty advisor to resolve this **before the project begins**.

:::{warning} Where this template runs out
Three things you must ask CUHS about rather than infer from this document:

- **Recording-specific requirements.** Harvard's detailed guidance pages are login-gated, and the requirements may change periodically. Please check guidance pages to see what exactly you require for the type of data you will be collecting.
- **State recording law.** Massachusetts requires all-party consent to record.
- **How your data must be stored.** Identifiable video and audio plausibly sit at Harvard [risk classification](https://privsec.harvard.edu/classify-risk) **Level 3**, and can reach **Level 4** where material is treated as biometric or where disclosure could put someone at risk. Do not guess the level, and do not assume a personal computer is an acceptable storage; check the CUHS website.

CUHS: [cuhs.harvard.edu](https://cuhs.harvard.edu/) · cuhs@harvard.edu · 617-496-2847
:::

### How to fill it in

Replace every placeholder. Keep the language plain — the federal requirement at [45 CFR 46.116](https://www.ecfr.gov/current/title-45/subtitle-A/subchapter-A/part-46/subpart-A/section-46.116) is that consent begins with *"a concise and focused presentation of the key information"* in language the participant can understand, and contains **no exculpatory language** (nothing asking them to waive rights). Short sentences beat formal ones.
