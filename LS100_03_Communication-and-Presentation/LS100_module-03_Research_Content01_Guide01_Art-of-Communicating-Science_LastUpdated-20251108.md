...
exports:
  - format: pdf
    ...
    output: exports/LS100_module-03_Research_Content01_Guide01_Art-of-Communicating-Science_LastUpdated-20251108.pdf
    id: comm-pdf
downloads:
  - id: comm-pdf
...
| --------------------- | ------------------------------------ | ----------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| **Setup / World**     | Establish the world and stakes       | Frame the *real-world problem* and why it matters                       | “What decision or outcome is at stake for this audience?”                                                     |
| **Protagonists**      | Introduce characters and goals       | Introduce *actors*: system, variables, stakeholders; your research goal | “Whose perspective clarifies the stakes (patient, public, researcher, policy maker, animal, cell, molecule)?” |
...
| **Trials**            | Obstacles and attempts               | Show key experiments or analyses, including dead ends where informative | “What did we learn from what *didn’t* work?”                                                                  |
| **Resolution**        | Conflict resolved                    | Present **results → plain-language meaning** with uncertainty           | “How big is the effect? How certain are we?”                                                                  |
...
| ----------------------------- | ---------------------------- | ----------------------------------------------------------------------------------------------------------------- | --------------------------- | --------------------------- | ----------------------------------------------------------------------- |
| **Research plan / proposal**  | Domain peers, funders        | Hook → So-what → Gap → **Design logic** → Proposed studies → Risks & mitigations → Impact / ethics → Ask          | 2 / 2 / 2 / 4 / 3           | 4 / 5 / 5 / 10 / 6          | Lead with stakes; foreground *why this approach will produce evidence*. |
| **Completed single study**    | Peers across fields          | Hook → So-what → Known → Gap → Methods (conceptual) → Results → Meaning + **uncertainty** → Limits → Implications | 3 / 2 / 1 / 1 / 2 / 3 / 2   | 6 / 4 / 3 / 3 / 6 / 8 / 4   | Keep methods conceptual; emphasize effect sizes and uncertainty.        |
| **Program update / progress** | Team, stakeholders           | Hook → Objectives → Milestones → What worked / learned → Risks / needs → Next steps                               | 2 / 3 / 4 / 3 / 2           | 5 / 7 / 10 / 5 / 3          | Highlight learning from failures; end with concrete next actions.       |
| **Public or policy briefing** | Non-experts, decision-makers | Relatable hook → So-what (stakes) → What’s known → What’s uncertain → Implications / options → Call to action     | 3 / 3 / 2 / 2 / 3           | 6 / 6 / 4 / 4 / 6           | Avoid deficit framing; connect to shared values and real-world choices. |
| **Investor / partner pitch**  | Funders, partners            | Problem size → Solution concept → Evidence so far → Path to scale → Risks → Ask                                   | 3 / 3 / 4 / 3 / 2           | 6 / 6 / 10 / 7 / 3          | Focus on evidence quality; be explicit about assumptions and risk.      |

Note: Time budgets are indicative; adjust to venue and audience. For all versions, use assertion–evidence slides and multimedia principles to reduce extraneous load and guide attention <sup>[4]</sup>.
...
3.  # Planning Your Talk
    
    1.  Know your audience: Start by mapping what your audience knows and cares about.
    
    2.  Content of your talk:
    
    3.  Structure of your talk:

Translate this into a Message Box: Problem → So what → What we know → What’s new → Call to action. Then build an hourglass structure: start broad (why it matters), narrow to methods and findings, and end broad again (implications and limits).
...
## 5. Delivering the Talk

You are the medium. Maintain eye contact, vary tone and pacing, and use micro-pauses (1–3 seconds) for emphasis. Engage with your audience through brief questions or prompts. Confidence grows from preparation and empathy, not from volume or speed.
...
## 10. Adapting to Posters, Writing, and Audio–Visual
...
[1]: https://nap.nationalacademies.org/catalog/23674/communicating-science-effectively-a-research-agenda

[2]: https://www.pnas.org/doi/pdf/10.1073/pnas.1320645111

[3]: https://assets.cambridge.org/97813166/38088/frontmatter/9781316638088_frontmatter.pdf

[4]: https://pure.psu.edu/en/publications/how-the-design-of-presentation-slides-affects-audience-comprehens

[5]: https://www.pnas.org/doi/pdf/10.1073/pnas.1319030111
